...
class TestOptimalStrategyRegression(unittest.TestCase):
    ...
    LEADING_FALLBACK_SEEDS = [121, 693, 820, 1841, 2199, 2774, 4143, 4201, 4437, 4885]
    ...
    def test_historical_optimal_vs_external_deadlock_seeds_complete(self):
    ...
    def test_historical_leading_fallback_seeds_complete_for_optimal_vs_basic(self):
        for seed in self.LEADING_FALLBACK_SEEDS:
            with self.subTest(seed=seed, mode="optimal_vs_basic"):
    ...
    def test_historical_leading_fallback_seeds_complete_for_optimal_vs_external(self):
        for seed in self.LEADING_FALLBACK_SEEDS:
            with self.subTest(seed=seed, mode="optimal_vs_external"):
                result = run_single_game_basic_vs_external(
                    game_number=seed,
                    seed=seed,
                    player_0_strategy="optimal",
